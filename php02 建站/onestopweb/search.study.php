...
<div class="result">
    ...
    <p class="f_l">当前位置：<a href="index.php">首页</a> &gt; <a href="search.study.php">视频教程</a>
    &gt;
<?php
...
?>
		<dl>
            ...
            <dd class="line01">
            	...
            	<i class="f_r" onclick="javascript:good(<?php echo $row[o_id]?>,<?php echo $row[o_good]?>,3);" id="good<?php echo $row[o_id]?>"><?php echo $row[o_good]?>个赞</i>
                <a href="info.study.php?id=<?php echo $row[o_id]?>" target="_blank" class="title" title="<?php echo $row[o_title]?>"><?php echo mb_substr($row[o_title],0,22,'utf-8')?></a>
                <?php 
                	if ($row[o_valid]==1){
                ?>
                	<a class="valid" onclick="javascript:valid(<?php echo $row[o_id]?>,3);" id="valid<?php echo $row[o_id]?>">有效</a>
                <?php
                	}else{
            ...
            <dd class="line02">
            	<?php echo mb_substr($row[o_con],0,86,'utf-8')?>......<a href="info.study.php?id=<?php echo $row[o_id]?>" target="_blank" class="title" title="<?php echo $row[o_con]?>">[更多]</a>
            </dd>
            <dd class="line03">
