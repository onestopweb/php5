<?php 
	...
	if ($_GET['order'] == 'onestopweb') {
		...
		if(_query($_sql)){
			_close();
			echo "<script type='text/javascript'>alert('提交信息成功');location.href='onestop.php';</script>";
			exit();
		}
	}
?>
...
<link rel="stylesheet" type="text/css" href="style/onestop.css" />
<link href="style/touch.css" rel="stylesheet" type="text/css" />
<script src="js/jquery-1.8.0.min.js" type="text/javascript"></script>
<script src="js/onestop.js" type="text/javascript"></script>
<!--[if IE 6]>
...
<div class="banner">
	<img src="images/onestop/banner.png" width="1000" height="350" class="png_bg" />
</div>
...
<div class="site">
	<a class="f_l">
    	<img src="images/onestop/site01.jpg" width="320" height="240" />
        <h4>企业形象网站设计</h4>
        <p>网站是企业产品和服务的网上包装。网站品质的第一印象决定了客户对您的产品和服务的信心。</p>
        <span>价格面议</span>
    </a>
    <a class="f_l">
    	<img src="images/onestop/site02.gif" width="320" height="240" />
        <h4>电子商务网站设计</h4>
        <p>提供传业的电子商务解决方案。从集成简单电子商务系统，到客户订制的大型复杂电子商务平台。</p>
        <span>价格面议</span>
    </a>
    <a class="f_l site_other">
    	<img src="images/onestop/site03.jpg" width="320" height="240" />
        <h4>高端品牌网站设计</h4>
        <p>个人网站，艺术类网站，论坛，博客，社区类网站都可以根据您的需求制作各类型个性化的网站。</p>
        <span>价格面议</span>
    </a>
</div>
...
<div class="info">
	<div class="info_box">
    	<h3>为何选一站式建网站</h3>
        <p><img src="images/onestop/info_1.png" width="1000" height="190" /></p>
        <h3>项目流程</h3>
        <p><img src="images/onestop/info_2.png" width="1000" height="190" /></p>
    </div>
</div>
...
<div class="online">
    ...
    <form name="orderForm" action="onestop.php?order=onestopweb" method="post">
