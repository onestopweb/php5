<?php 
	...
	if ($_GET['action'] == 'onestopweb') {
		...
		$_sql = "INSERT INTO o_software ( o_title ,o_link ,o_con ,o_img ,o_time ,o_see ,o_good ,o_top ,o_valid ,o_type_id ,o_user_id)
			VALUES ('$_title', '$_link', '$_con', '$_img', NOW(), '43', '3', '$_top', '1', '$_type', '$_name')";
		_query($_sql);
		_close();
		echo "<script type='text/javascript'>location.href='list.software.php';</script>";
		exit();
	}
?>
...
<div class="update">
<form action="add.software.php?action=onestopweb" method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0">
    ...
    <tr><td class="h38 b">打开链接：</td><td><input type="text" name="link" class="text f_l" /><em class="f_l">百度网盘的下载链接</em></td></tr>
