<?php 
	...
	if ($_GET['action'] == 'onestopweb') {
		...
		$_sql = "INSERT INTO o_liber ( o_title ,o_link ,o_con ,o_img ,o_time ,o_see ,o_good ,o_top ,o_valid ,o_type_id ,o_user_id)
			VALUES ('$_title', '$_link', '$_con', '$_img', NOW(), '43', '3', '$_top', '1', '$_type', '$_name')";
		_query($_sql);
		_close();
		echo "<script type='text/javascript'>location.href='list.liber.php';</script>";
		exit();
	}
?>
...
<div class="update">
<form action="add.liber.php?action=onestopweb" method="post" enctype="multipart/form-data">
