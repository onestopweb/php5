<?php
	...
	$_id = $_GET['id'];
	if($_GET['id']!=null){
		$_sql = "SELECT * FROM e_yyzj WHERE e_id = $_id LIMIT 1 ";
		...
		if ($_GET['action'] == 'edata') {
			...
			_query($_sql_update);
			_close();
			echo "<script type='text/javascript'>location.href='list.yyzj.php';</script>";
			exit();
		}
	}else{
		_close();
...
<div class="update">
<form action="update.yyzj.php?id=<?php echo $_id?>&action=edata" method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0">
	<tr class="head"><td colspan="2">修改信息</td></tr>
   	...
   	<tr><td class="h38 b">主图替换：</td><td><img src="../product/20/<?php echo $_result[e_img];?>" class="f_l" style="padding-left: 10px;"></img><input type="file" class="file f_l" name="userfile" /><em class="f_l">图片文件上传支持 .png .jpg .gif格式&nbsp;&nbsp;图片长度为88*118</em></td></tr>
   	<tr><td colspan="2">
        	<!-- 加载编辑器的容器 -->
