...
<div class="menu">
	<div class="box" id="rand_img">
    	<h2>后台管理系统</h2>
        <em><img src="images/logo.png" /></em>
        <p>管理员：<?php echo $_name?></p>
        <p><a href="../index.php" target="_blank">打开首页</a>&nbsp;&nbsp;<a href="logout.ref.php">注销</a></p>
    </div>
    <h3 style="display:none;"><a id="menu1">用户管理</a></h3>
    <ul id="menu1_hover" style="display:none;">
        <li><a href="user.add.php" target="main">新增用户</a></li>
    </ul>
    <h3><a id="menu2">妇科中心</a></h3>
     <ul id="menu2_hover" style="display:none;">
    	<li><a href="list.fkzx.php" target="main">查看信息</a></li>
    	<li><a href="add.fkzx.php" target="main">增加信息</a></li>
    </ul>
    <h3><a id="menu3">男科中心</a></h3>
     <ul id="menu3_hover" style="display:none;">
    	<li><a href="list.nkzx.php" target="main">查看信息</a></li>
    	<li><a href="add.nkzx.php" target="main">增加信息</a></li>
    </ul>
    <h3><a id="menu4">计划生育</a></h3>
     <ul id="menu4_hover"style="display:none;">
    	<li><a href="list.jhsy.php" target="main">查看信息</a></li>
    	<li><a href="add.jhsy.php" target="main">增加信息</a></li>
    </ul>
    <h3><a id="menu5">医院专家</a></h3>
     <ul id="menu5_hover"style="display:none;">
    	<li><a href="list.yyzj.php" target="main">查看信息</a></li>
    	<li><a href="add.yyzj.php" target="main">增加信息</a></li>
    </ul>
    <h3><a id="menu6">特色技术</a></h3>
     <ul id="menu6_hover"style="display:none;">
    	<li><a href="list.tsjs.php" target="main">查看信息</a></li>
    	<li><a href="add.tsjs.php" target="main">增加信息</a></li>
    </ul>
    <h3><a id="menu7">典型案例</a></h3>
     <ul id="menu7_hover"style="display:none;">
    	<li><a href="list.dxal.php" target="main">查看信息</a></li>
    	<li><a href="add.dxal.php" target="main">增加信息</a></li>
    </ul>
</div>
<?php 
