<?php
	...
	if($_GET['id']!=null){
		...
		if ($_GET['action'] == 'edata') {
			...
			_query($_sql_update);
			_close();
			echo "<script type='text/javascript'>location.href='list.nkzx.php';</script>";
			exit();
		}
	}else{
		_close();
...
<div class="update">
<form action="update.nkzx.php?id=<?php echo $_id?>&action=edata" method="post">
