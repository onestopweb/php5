<?php
	...
	if ($_GET['action'] == 'edata') {
		...
		$_sql_add = "INSERT INTO e_yyzj (e_title, e_img, e_cont, e_time, e_see, e_name)
				 VALUES ('$_title', '$_img', '$_cont', NOW(), '1', '$_name')";
		_query($_sql_add);
		_close();
...
<div class="update">
<form action="add.yyzj.php?action=edata" method="post" enctype="multipart/form-data">
<table cellpadding="0" cellspacing="0">
	<tr class="head"><td colspan="2">增加信息</td></tr>
   	...
   	<tr><td class="h38 b">主图上传：</td><td><input type="file" class="file f_l" name="userfile" /><em class="f_l">图片文件上传支持 .png .jpg .gif格式&nbsp;&nbsp;图片长度为88*118</em></td></tr>
   	<tr><td colspan="2">
        	<!-- 加载编辑器的容器 -->
