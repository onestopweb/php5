<?php
	...
	if ($_GET['action'] == 'edata') {
		...
		$_cont = $_POST['content'];
		$_type = $_POST['type'];
		$_sql_add = "INSERT INTO e_fkzx (e_title, e_cont, e_type, e_time, e_see, e_name)
				 VALUES ('$_title', '$_cont', '$_type', NOW(), '1', '$_name')";
		_query($_sql_add);
		_close();
...
<div class="update">
<form action="add.fkzx.php?action=edata" method="post">
