...
?>
	<div class="index">
		<div class="head">
			<h1><a href="nkzx.type.php?type=<?php echo $_type ?>"><?php echo $_nkzx_type[$_type-1]; ?></a></h1>
		</div>
	</div>
	<div class="button">
		<div>
	...
	<div class="list">
		<ul>
			<?php
				...
				$_sql_list = "SELECT * FROM e_nkzx WHERE e_type = $_type order by e_time DESC LIMIT $_page_begin , $_page_size";
	...
	<div class="pagination">
		<ul>
			<?php
				$_sql_count = "SELECT count( e_id ) FROM e_nkzx WHERE e_type = $_type";
